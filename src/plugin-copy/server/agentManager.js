...
// Cursor agent now uses --print mode (non-interactive JSON streaming)
// instead of the TUI. Each message spawns a child process.
...
export async function sendChatMessage(agentId, userContent, displayContent, attachedFiles) {
  ...
  try {
    ...
    // Phase 1b: Generate a brief internal reasoning summary
    let thinkingSummary = '';
    try {
