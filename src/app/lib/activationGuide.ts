...
export const ACTIVATION_FIELD_GUIDES: Record<string, ActivationFieldGuide> = {
  ...
  'pdv-list': {
    ...
    bannerTitle: 'Revisa tu tienda y la caja',
    bannerDetail: 'Abre la tarjeta de la tienda y confirma que el PDV (caja) está activo.',
  },
  'store-hours': {
...
export const ACTIVATION_SUBSTEP_GUIDES: Record<string, ActivationSubStepGuide> = {
  ...
  active_pdv: {
    fieldKey: 'pdv-list',
    route: '/saas/settings/tienda',
    clickHint: 'Abre tu tienda y revisa que la caja (PDV) esté activa',
  },
  // Delivery — marca
  brand_ready: {
    fieldKey: 'edit-brand',
