...
const es: LandingCopy = {
  ...
  hero: {
    ...
    ctaTrial: 'Probar Vertial gratis',
    ctaAffiliate: 'Hazte colaborador',
    perks: ['Sin tarjeta', '30 días gratis', 'Sin permanencia', 'Datos en Europa'],
    opsToday: '+24 ops. hoy',
  ...
  finalCta: {
    ...
    titleAccent: 'Vertial',
    subtitle: '30 días gratis · Sin tarjeta · Soporte en español',
...
const en: LandingCopy = {
  ...
  hero: {
    ...
    ctaTrial: 'Try Vertial free',
    ctaAffiliate: 'Become a partner',
    perks: ['No card required', '30-day free trial', 'No lock-in', 'Data in Europe'],
  ...
  pricing: {
    ...
    subtitle: 'Scale when you need. No lock-in, with a 30-day free trial.',
    monthly: 'Monthly',
    yearly: 'Yearly',
    perMonth: '/mo',
  ...
  finalCta: {
    ...
    titleAccent: 'Vertial',
    subtitle: '30 days free · No card · Support available',
    startNow: 'Start now',
    ...
    items: [
      {
        ...
        a: 'No. You can start using Vertial with just an email and password.',
      },
      {
        q: 'What happens after the 30-day trial?',
        a: 'You can choose the plan that fits your business. If you don’t, the account pauses and your data is kept for 90 days.',
      },
      {
