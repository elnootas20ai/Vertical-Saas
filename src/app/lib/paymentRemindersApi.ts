...
const REMINDERS_DB = (env.VITE_COUCHDB_DB || 'vertial') + '-payment-reminders';
...
async function ensureDb() {
  await ensureCouchDb(REMINDERS_DB, () => req(`/api/couch/db/${encodeURIComponent(REMINDERS_DB)}`, { method: 'PUT' }));
}
