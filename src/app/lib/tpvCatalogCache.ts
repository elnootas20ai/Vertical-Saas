...
export const TPV_CATALOG_CACHE_SCHEMA = 'v19-combo-slot-surcharges';
...
function liteCatalogItem(item: CatalogItem): CatalogItem {
  ...
  if (cf.comboSlotAllowlists && typeof cf.comboSlotAllowlists === 'object' && !Array.isArray(cf.comboSlotAllowlists)) {
    customFields.comboSlotAllowlists = cf.comboSlotAllowlists;
  }
  if (cf.comboSlotSurcharges && typeof cf.comboSlotSurcharges === 'object' && !Array.isArray(cf.comboSlotSurcharges)) {
    customFields.comboSlotSurcharges = cf.comboSlotSurcharges;
  }
  if (cf.halfHalf === true) {
