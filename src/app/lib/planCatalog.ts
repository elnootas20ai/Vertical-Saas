...
export const VERTIAL_PLANS: VertialPlanDefinition[] = [
  {
    ...
    features: [
      ...
      'Operativa mínima del vertical + TPV y Verifactu',
  ...
  },
  {
    ...
    features: [
      ...
      'Inventario / stock',
      'Escandallo / costing',
      'Proveedores y compras con OCR (foto/subida)',
      'Clientes básicos y Dashboard 1',
  ...
  },
  {
    ...
    features: [
      ...
      'OPS, modo offline y todos los SVA incluidos',
