...
export function SalaTableConfigRow({
  ...
  return (
    <tr
      className={`border-b border-gray-100 last:border-b-0 dark:border-gray-800/80 ${
        isActive ? '' : 'opacity-70'
      }`}
    >
      ...
      <td className="px-3 py-2.5 align-middle">
        <select
          ...
          className="w-full min-w-[5.5rem] max-w-[7.5rem] rounded-lg border border-gray-200 bg-gray-50 px-2 py-1.5 text-xs font-medium text-gray-700 outline-none focus:border-gray-400 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200"
        >
      ...
      <td className="px-3 py-2.5 align-middle">
        <div className="inline-flex items-center rounded-lg border border-gray-200 dark:border-gray-700">
          <button
            ...
            className="flex h-8 w-8 items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-800"
      ...
      <td className="px-3 py-2.5 align-middle text-right">
        <button
          ...
          className="inline-flex items-center gap-1 rounded-lg px-2 py-1.5 text-xs font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/30"
        >
