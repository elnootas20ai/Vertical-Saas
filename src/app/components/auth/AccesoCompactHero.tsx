...
export function AccesoCompactHero({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-3 p-4 sm:p-5 md:flex-row md:items-center md:justify-between md:gap-6 lg:gap-8">
        <div className="flex items-start gap-3 sm:gap-4 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <h2 className="mt-1.5 sm:mt-2 text-lg sm:text-xl md:text-2xl font-bold leading-tight text-white">{content.title}</h2>
        ...
        <ul className="flex flex-wrap gap-x-3 gap-y-1.5 sm:gap-x-4 sm:gap-y-2 md:justify-end shrink-0 pl-11 sm:pl-0">
