    ...
    <Layout title="Configuraci\u00f3n inicial" subtitle="Prepara tu negocio paso a paso">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
          <button onClick={async () => { await skipAll(); navigate('/saas/dashboard'); }} className="flex items-center gap-1.5 text-sm text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
            <SkipForward className="w-4 h-4" /> Saltar todo e ir al Dashboard
          </button>
