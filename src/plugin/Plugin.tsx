...
import { Bot, Loader2, AlertCircle, X, Maximize2, Minimize2, Plus } from 'lucide-react';
...
export function Plugin({
  ...
  const {
    ...
    loading, error, connectionStatus, selectAgent, deselectAgent, createAgent,
  ...
  const [sidebarTab, setSidebarTab] = useState<'agents' | 'apps' | 'components' | 'code' | 'kanban' | 'database' | 'logs' | 'empresas' | 'settings'>('agents');
