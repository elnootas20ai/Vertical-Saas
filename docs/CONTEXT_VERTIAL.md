# Contexto de infraestructura Vertial / vertialapp.com
...
## 4. Qué revisar **antes** de tocar el proyecto (conexiones “fuera” de Vertial / esta IP / local)
...
- **`COUCHDB_URL` / credenciales** — Deben ser la instancia CouchDB que usáis **ahora** (local en dev, servidor en prod). No son el dominio público del producto, pero sí conexión crítica.
...
### Servicios externos (no son “malos”; no hay que sustituirlos por tu dominio propio)
