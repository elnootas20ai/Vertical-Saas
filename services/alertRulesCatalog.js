...
export const ALL_ALERT_RULE_DEFINITIONS = [
  ...
  r('supplier_price_changed', 'stock', 'catalogProviders', 'Precio proveedor distinto', 'El albarán o factura llega con precio unitario distinto al coste esperado del proveedor', { ...pushInApp, urgency: 'high' }),
  ...
  r('high_waste', 'stock', 'catalogProviders', 'Merma alta', 'Coste de merma supera el umbral sobre ventas (7 días)', { ...pushInApp, urgency: 'high' }),
  r('recipe_missing_sold', 'stock', 'catalogProviders', 'Venta sin escandallo', 'Productos vendidos hoy sin receta/escandallo', { ...pushInApp, urgency: 'medium' }),
