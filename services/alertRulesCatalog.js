...
export const ALL_ALERT_RULE_DEFINITIONS = [
  ...
  r('tax_deadline_overdue', 'finanzas', 'finanzas', 'Obligación fiscal vencida', 'Plazo fiscal superado sin presentar', { urgency: 'critical' }),
  ...
  r('cleaning_client_unpaid', 'limpieza', 'limpieza', 'Cliente impagado', 'Cliente de limpieza con facturas pendientes', { urgency: 'high' }),
  ...
  r('construction_collection_overdue', 'construccion', 'construccion', 'Cobro vencido en obra', 'Certificación o cobro de obra vencido', { urgency: 'high' }),
  r('construction_payment_overdue', 'construccion', 'construccion', 'Pago de obra vencido', 'Pago a proveedor o subcontrata vencido', { urgency: 'high' }),
  ...
  r('scrapyard_sale_unpaid', 'desguaces', 'verticales', 'Venta desguace sin cobrar', 'Venta realizada con pago pendiente', { urgency: 'high' }),
  ...
  r('butcher_register_pending', 'carniceria', 'verticales', 'Caja carnicería sin cerrar', 'Sesión de caja de carnicería abierta demasiado tiempo', { urgency: 'high' }),
  ...
  r('cv_sale_unpaid', 'compraventa', 'verticales', 'Venta CV sin cobrar', 'Venta de vehículo con pago pendiente', { urgency: 'high' }),
