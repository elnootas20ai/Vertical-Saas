...
const scriptPath = path.join(
  ...
  'fix-disarmink-separar-bebidas-cervezas-vinos.mjs',
);
...
cd '${repo.replace(/'/g, `'\\''`)}'
mkdir -p scripts
echo '${b64}' | base64 -d > scripts/fix-disarmink-separar-bebidas-cervezas-vinos.mjs
node scripts/fix-disarmink-separar-bebidas-cervezas-vinos.mjs${APPLY ? ' --apply' : ''}
`;
