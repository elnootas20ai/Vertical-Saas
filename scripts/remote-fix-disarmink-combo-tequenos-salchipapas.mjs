...
const scriptPath = path.join(
  ...
  'fix-disarmink-combo-tequenos-salchipapas.mjs',
);
...
cd '${repo.replace(/'/g, `'\\''`)}'
mkdir -p scripts
echo '${b64}' | base64 -d > scripts/fix-disarmink-combo-tequenos-salchipapas.mjs
node scripts/fix-disarmink-combo-tequenos-salchipapas.mjs${APPLY ? ' --apply' : ''}
`;
