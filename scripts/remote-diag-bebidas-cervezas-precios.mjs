...
const scriptPath = path.join(
  ...
  'diag-bebidas-cervezas-precios.mjs',
);
...
cd '${repo.replace(/'/g, `'\\''`)}'
mkdir -p scripts
echo '${b64}' | base64 -d > scripts/diag-bebidas-cervezas-precios.mjs
node scripts/diag-bebidas-cervezas-precios.mjs
`;
console.log('[remote] diag bebidas/cervezas');
