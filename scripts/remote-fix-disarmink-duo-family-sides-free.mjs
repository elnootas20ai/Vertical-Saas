...
const scriptPath = path.join(
  ...
  'fix-disarmink-duo-family-sides-free.mjs',
);
...
cd '${repo.replace(/'/g, `'\\''`)}'
mkdir -p scripts
echo '${b64}' | base64 -d > scripts/fix-disarmink-duo-family-sides-free.mjs
node scripts/fix-disarmink-duo-family-sides-free.mjs${APPLY ? ' --apply' : ''}
`;
