#!/usr/bin/env node
/** Sube módulos de alertas/correo al VPS y reconstruye app (sin push a git). */
...
const files = [
  'index.js',
  'services/adminInbox.js',
  'services/adminAlertEmail.js',
  'services/adminAlerts.js',
  'services/email.js',
...
for (const rel of files) {
  ...
  console.log('[hotfix:alerts] SCP', rel);
...
console.log('[hotfix:alerts] Rebuild docker...');
