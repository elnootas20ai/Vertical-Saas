...
const scriptPath = path.join(
  ...
  'fix-disarmink-restore-tacos-items.mjs',
);
...
cd '${repo.replace(/'/g, `'\\''`)}'
mkdir -p scripts
echo '${b64}' | base64 -d > scripts/fix-disarmink-restore-tacos-items.mjs
node scripts/fix-disarmink-restore-tacos-items.mjs${applyFlag}
`;
