...
const vars = {
  ...
  // Login menos agresivo (el cliente puede fallar al resetear sin quedar bloqueado enseguida)
  MAX_LOGIN_ATTEMPTS: '12',
  LOCK_DURATION_MINUTES: '2',
  LOGIN_RATE_LIMIT_MAX: '40',
  RECOVER_RATE_LIMIT_MAX: '20',
  // VPS ~16 GB: no avisar por el pico normal del Node (~1.2–1.5 GB).
  ALERT_RSS_MB: '4000',
  ALERT_HEAP_MB: '1800',
...
grep -E '^(EMAIL_FROM_NAME|EMAIL_REPLY_TO|PUBLIC_SUPPORT|ALERTS_|BUG_|AFFILIATE_|DEFAULT_CONTACT|MAX_LOGIN|LOCK_DURATION|LOGIN_RATE|RECOVER_RATE|ALERT_RSS|ALERT_HEAP|ALERT_DISK|ALERT_5XX|ALERT_BACKUP|NODE_MAX_OLD)=' .env | sort
