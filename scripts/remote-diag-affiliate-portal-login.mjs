...
const emailArg = process.argv.find((a) => a.startsWith('--email=')) || '--email=munozluis.com@gmail.com';
...
const name = 'diag-affiliate-portal-login.mjs';
