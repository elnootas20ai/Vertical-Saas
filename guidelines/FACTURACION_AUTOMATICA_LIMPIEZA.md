...
| **Frontend — Billing.tsx** | `src/app/pages/saas/Billing.tsx` | Redirect a `/saas/settings/facturacion` (facturación de la suscripción Vertial, NO de clientes) | Es un redirect, no una página de facturación a clientes |
